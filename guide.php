                ...
                <div class="row align-items-center" style="min-height: 60px;">
                    <div class="col-md-10">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3 mb-md-0">
                                    <input type="number" class="form-control p-4" style="height: 47px;"placeholder="Duration">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container py-5">
            <div class="row">
                <div class="col-lg-8">
                   ...
                   <button class="bg-primary border-primary text-white"style="border:0;margin-bottom:20px;width:50%;">BOOK</button>
                </div>
