...
<div class="nav-bar">
   ...
   <div class="home">
            ...
            <div class="a">
            <a href="application.php"><img src="pic/icon/calendar.png"width="40%"height="50%"></a>
            <h2>Booking</h2>
            </div>
            <div class="b">
            <a href="package.php"><img src="pic/icon/box.png"width="40%"height="50%"></a>
            <h2>Packages</h2>
            </div>
            <div class="c">
            <a href="destination.php"><img src="pic/icon/map.png"width="40%"height="50%"></a>
            <h2>Destination</h2>
            </div>
        </div>
    </div>
