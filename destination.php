...
<head>
    <meta charset="utf-8">
    <title>Pulmmer Tours | Blog</title>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="row pb-3"id="blog_panel">
                        ...
                        <?php
                                    ...
                                    $selectdest="select * from blog where blog_id=? limit 1 ";
                                    ...
                                    while($rowdest=mysqli_fetch_assoc($resultdest)){
                                        ...
                                        $selectCat="select * from blog_pics where destination_id='$destinationid'";
                                    $result=$conn->query($selectCat);
                                    while($row=mysqli_fetch_assoc($result)){
                                        ?>
                                       <div id="carouselExampleControls" class="carousel slide blog_carousel" data-ride="carousel"style="width:100%;">
                                        ...
                                        <?php
                                            ...
                                            <img class="d-block w-100" src="<?= 'uploads/blog/'.$rows['pic_name'];?>"alt="First slide"style="width:100%">
                                            </div>
                                            <?php
                                            $i++;
                                                }
                                    ...
                                    /*without search*/
                                        ...
                                        $selectdest="select * from blog limit 1";
                            $resultdest=$conn->query($selectdest);
                            $count=mysqli_num_rows($resultdest);

                            if($count>0){
                            while($rowdest=mysqli_fetch_assoc($resultdest)){
                            $_SESSION['blogid']=$rowdest['blog_id'];
                        $blogid=$_SESSION['blogid'];
                        $selectCat="select * from blog_pics where destination_id='$blogid'";
                    $result=$conn->query($selectCat);
                    while($row=mysqli_fetch_assoc($result)){
                        ?>
                       <div id="carouselExampleControls" class="carousel slide blog_carousel" data-ride="carousel"style="width:100%;">
                    ...
                    echo "<p style='font-size:25px;color:black;'>No Blogs at the moment &#128531;</p>";
                }
            }
                    ?>  
                        <!--rows end here-->
