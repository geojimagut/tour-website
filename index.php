...
<head>
    <meta charset="utf-8">
    <title>Welcome | Pulmmer Tours</title>
...
<body>
    ...
    <!-- Carousel Start -->
<style>
    .container-fluid #header-carousel img{
        height:auto;
    }
</style>
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
 ...
 $selectCat="select * from home_slide";
...
<?php
 ...
 <div class="carousel-item <?=$actives;?> ">
   <img class="d-block w-100" src="<?= 'uploads/homeslider/'.$rows['image_name'];?>" height="450px" alt="Oops! No image">
   <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <!-- <h4 class="text-white text-uppercase mb-md-3">Tours & Travel</h4> -->
                            <h1 class="display-3 text-white mb-md-4">Wonder, <span style="color:yellow">Explore,</span> Discover</h1>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="service-item bg-white text-center mb-2 py-5 px-4">
                        ...
                        <h5 class="mb-2">Diverse Destinations</h5>
                        <p class="m-0">Travel to various destinations across the world with us. The destination choice is all yours!</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="service-item bg-white text-center mb-2 py-5 px-4">
                        <i class="fa fa-forward fa-forward mx-auto mb-4"></i>
                        <h5 class="mb-2">Fast Booking</h5>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="service-item bg-white text-center mb-2 py-5 px-4">
                        ...
                        <p class="m-0">Amazing tour offers throught the year just for you</p>
                    </div>
                </div>
            </div>
        </div>
...
<style>
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            ...
            <div class="row">
                    <?php
                        $selectCat="select * from packages inner join package_images on packages.id=package_images.package_id inner join destinations on packages.dest_id=destinations.destination_id group by package_id limit 6";
                        $result=$conn->query($selectCat);
                        while($row=mysqli_fetch_assoc($result)){
                        ?>
                                <div class="col-lg-4 col-md-6 mb-4">
...
<button class="button-33 package_link bg-primary" role="button"><i class="fa fa-phone-alt mr-2"></i> Inquire</button>
                                        ...
                                        <!-- <a href="#" class="le_btn package_link"style="font-size:18px"> Inquire</a> -->
